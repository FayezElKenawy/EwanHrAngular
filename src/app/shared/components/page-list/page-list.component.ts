...
export class PageListComponent implements OnInit  {
  ...
  constructor(public _dynamicSearchService: DynamicSearchService,
    private _http: HttpClient) {
      debugger;
    }

  ngOnInit(){
    this.searchForm = this._dynamicSearchService.buildSearchForm(this.pageListConfig?.cols);
    this.operators = this._dynamicSearchService.operators;
  }

  getPagedList() {
    debugger;
     this._http.post<PagedList>(`${this.pageListConfig.getDataAPIURL}`, this.searchModel)
