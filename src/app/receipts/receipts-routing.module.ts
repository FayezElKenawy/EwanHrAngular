...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: "details-credit-note/:id", component: EditCreditNoteComponent },
      { path: "debit-notes", component: ListDebitNotesComponent },
      { path: "payment-receipts", component: ListPaymentReceiptsComponent },
      {
      ...
      { path: "customers-accounts", component: ListCustomerAccountComponent },
      {
