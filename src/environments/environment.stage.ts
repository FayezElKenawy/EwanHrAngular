export const environment = {
  ...
  individualSectorURL: "http://185.230.211.136:74/ERP.IndividualSector",
  businessSectorURL: "http://185.230.211.136:74/ERP.BusinessSector",
  houseLabourSectorUrl: "http://185.230.211.136:74/ERP.HouseLabourSector",
  
  storagePath: "http://185.230.211.136:74/BroaERP.Core.API/Uploading/File/Public",
